    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow pt-24 px-4 pb-16 bg-gray-50 flex items-start justify-center">
        ...
        <CardContent className="prose prose-zinc lg:prose-lg max-w-none pt-6">
            ...
            <h2 className="text-2xl font-bold mt-6">2) What TwoPaws is (and isn’t)</h2>
            <p>
            ...
            <p>
              Keep your login credentials confidential; you’re responsible for activity under your account. Provide accurate
            ...
            <p>We may update these Terms; we’ll update the “Last updated” date above and, where required, provide in-app or email notice. Continued use after changes means you accept the updated Terms.</p>
